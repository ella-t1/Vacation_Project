...
class UserManagement:
    ...
    def _validate_password(self, password: str) -> bool:
        ...
        return bool(password and isinstance(password, str) and len(password) >= self.min_password_length and self.password_pattern.match(password))

    def _validate_name(self, name: str) -> bool:
        """Validate name format."""
        return bool(name and isinstance(name, str) and len(name.strip()) >= 2 and name.strip().isalpha())
